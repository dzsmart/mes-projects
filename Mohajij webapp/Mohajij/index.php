...
<title>Mohajij | Smart and smooth Hajj</title>   
...
<header>
    <div class="sticky-nav">
        ...
        <div id="logo">
        	<a id="goUp" href="#home-slider" title="Mohajij | Smart and smooth Hajj">Brushed Template</a>
        </div>
        
        <nav id="menu">
        	<ul id="menu-nav">
            	<li class="current"><a href="#home-slider">Home</a></li>
                <li><a href="#work">Manage Crawd</a></li>
                <li><a href="#about">Trafic</a></li>
        ...
        <div class="row">
            <div class="span12">
                <div class="title-page">
                    ...
                    <h3 class="title-description">Please select a <a href="#">Workspace</a>.</h3>
                </div>
            </div>
        </div>
        <!-- End Title Page -->
        	...
        	<div class="span3">
                ...
                <nav id="options" class="work-nav">
                    <ul id="filters" class="option-set" data-option-key="filter">
                    	<li class="type-work">Managment Of :</li>
                        <li><a href="#filter" data-option-value="*" class="selected">All Types</a></li>
                        <li><a href="#filter" data-option-value=".design">Food</a></li>
                        <li><a href="#filter" data-option-value=".photography">Trafic</a></li>
                        <li><a href="#filter" data-option-value=".video">Crawd</a></li>
                        <li><a href="#filter" data-option-value=".video">Video Surveance</a></li>
                    </ul>
                </nav>
                <!-- End Filter -->
            </div>
...
<!-- Footer -->
<footer>
	<p class="credits">&copy;2018 Mohajij. <a href="#" title="Mohajij | Smart and smooth Hajj">El Mohajij</a> by <a href="#" title="Hackathon Team | G-22">Hackathon Team | G-22</a></p>
</footer>
<!-- End Footer -->
